...
\section{Full-Stack Software Engineer}
    A Software Engineer with over a decade of experience across diverse industries. I apply expertise in all stages of the software development lifecycle and implement best practices to drive business outcomes. I effectively collaborate with teams to achieve project goals. Key skills include:
    \vspace{-6pt}
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Rewrite the whole legacy admin panel, replacing it with a modern and slick alternative for two sweepstakes casino platforms: chanced.com and punt.com.}
        \resumeItem{Optimize the entire backend API suite to handle 16k concurrent user.}
        \resumeItem{Created a new fraud detection mechanism for the user redemption workflow, resulting in a 38\% reduction in fraud.}
        \resumeItem{Implemented a new load testing infrastructure that could simulate up to 25k concurrent users, ensuring every new feature maintained performance and stability.}
        \resumeItem{Used: PHP, Laravel, Postgres, Redis, React, Docker, AWS, k6, etc.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Used: PHP, Laravel, Lumen, Node.js, Express.js, PostgreSQL, Jenkins, Docker, AWS, Ansible, Angular, XMPP, etc.}
      \resumeItemListEnd
