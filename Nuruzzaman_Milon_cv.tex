...
\begin{center}
    ...
    \small 
        \textbf{
            \href{tel:+1 (437) 557 2235}{\faMobile \enspace +1 (437) 557 2235} $|$ 
        ...
        \href{https://linkedin.com/in/tomilon}{\faLinkedinSquare \enspace tomilon} $|$
        \href{https://github.com/milon}{\faGithub \enspace milon} $|$
        \href{https://twitter.com/to_milon}{\faTwitter \enspace @to\_milon}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Creating own navigation system for the bus drivers in the FlixDriver app.}
        \resumeItem{Build lost and found reporting system right in the FlixDriver app.}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bsc Engineering in Information and Communication Technology (ICT)}{April 2009 -- August 2013}
      \resumeItemListStart
...
\section{Books}
  \resumeSubHeadingListStart    
    \resumeSubheading
      {\textbf{Laravel PHP Web Framework}}{\textit{May 2015}}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \resumeItemListStart
      ...
      \resumeItem{Amazon AWS(EC2, S3, RDS, SQS), Google Cloud Services}
      \resumeItem{Git, SVN}
